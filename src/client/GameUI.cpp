...
CommandCenter GameUI::get_command_center(){
...
void GameUI::draw_home_field(BattleField field){
    this->draw_field(home_win,field);
}

void GameUI::draw_enemy_field(BattleField field){
    this->draw_field(enemy_win,field);
}

void GameUI::draw_hit_mark(WINDOW *win, position_t position, bool is_ship){
...
void GameUI::show_field(BattleField home_content){
...
void GameUI::draw_available_ships(BattleField field){
    int y = 5;
...
void GameUI::write_message(std::string message){
